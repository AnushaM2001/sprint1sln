# Generated by Django 5.0.6 on 2024-08-09 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_applicant_mobile_number', models.CharField(default='', max_length=15, validators=[anusha.models.validate_mobile_number])),
                ...
                ('co_applicant_net_income_per_month', models.IntegerField(default=10000, validators=[anusha.models.validate_amount])),
                ('random_number', models.CharField(blank=True, max_length=20, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
