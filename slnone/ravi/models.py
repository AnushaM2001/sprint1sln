...
class CustomerProfile(models.Model):
    ...
    gst_number = models.CharField(max_length=15, blank=True, null=True, validators=[validate_gst_number],default='00AAAAA0000A1Z')
    ...
    business_location = models.CharField(max_length=100, blank=True, null=True, validators=[validate_address])
    business_address_pincode = models.CharField(max_length=6, blank=True, null=True, validators=[validate_pincode])
    house_plot_purchase_value = models.CharField(max_length=10, blank=False, null=False, validators=[validate_amount],default="eneter")
    required_loan_amount = models.CharField(max_length=10, blank=False, null=False, validators=[validate_amount],default="enter")
    ...
    ref1_person_name = models.CharField(max_length=200, blank=False, null=False, validators=[validate_only_letters],default='')
    ref2_person_name = models.CharField(max_length=200, blank=False, null=False, validators=[validate_only_letters],default='')
    ref1_mobile_number = models.CharField(max_length=10, blank=False, null=False, validators=[validate_mobile_number],default='')
    ref2_mobile_number = models.CharField(max_length=10, blank=False, null=False ,validators=[validate_mobile_number],default='')
    ...
    coapplicant_age = models.DateField(default='enter', validators=[validate_age])
